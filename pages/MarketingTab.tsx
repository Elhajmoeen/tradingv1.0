...
export default function MarketingTab({ clientId }: MarketingTabProps) {
  const [openSections, setOpenSections] = useState<Record<string, boolean>>({})
  
  const tab = profileTabs.find(t => t.id === 'marketing')
  ...
  if (!tab) {
    return <div className="text-muted-foreground">Marketing tab configuration not found</div>
  }
