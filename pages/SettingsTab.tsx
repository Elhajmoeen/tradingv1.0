...
export default function SettingsTab({ clientId }: SettingsTabProps) {
  const [openSections, setOpenSections] = useState<Record<string, boolean>>({})
  
  const tab = profileTabs.find(t => t.id === 'settings')
  ...
  if (!tab) {
    return <div className="text-muted-foreground">Settings tab configuration not found</div>
  }
