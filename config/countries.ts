...
export const COUNTRIES: CountryItem[] = [
  ...
  { iso2: 'IR', name: 'Iran, Islamic Republic of', dialCode: '98' },
  ...
  { iso2: 'MD', name: 'Moldova, Republic of', dialCode: '373' },
  ...
  { iso2: 'SX', name: 'Sint Maarten (Dutch part)', dialCode: '1' },
  ...
  { iso2: 'TW', name: 'Taiwan, Province of China', dialCode: '886' },
  { iso2: 'TZ', name: 'Tanzania, United Republic of', dialCode: '255' },
  ...
  { iso2: 'VE', name: 'Venezuela, Bolivarian Republic of', dialCode: '58' },
 ...
 */
export const findCountryByCode = (isoCode: string): CountryItem | undefined => {
  return COUNTRIES.find(c => c.iso2 === isoCode.toUpperCase())
}
...
/**
 * Get display name for country (used for exports and display)
 */
export const getCountryDisplayName = (isoCodeOrName: string): string => {
  const country = findCountryByCode(isoCodeOrName) || findCountryByName(isoCodeOrName)
  return country ? country.name : isoCodeOrName
}